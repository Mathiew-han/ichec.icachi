...
徵稿頁面已按投稿類別組織。請先選擇與你工作最匹配的 track，再查看該類別對應的主題範圍、時間線和材料要求。

## 通用徵稿範圍

ICHEC 2026 歡迎人機互動與 Human-Engaged Computing 全領域投稿，包括但不限於：

- 人機協作、生成式 AI 與 HCI、智能互動和負責任技術
- 無障礙、老齡化、健康、教育、家庭、遊戲、娛樂與社交計算
- 互動技術、設備、模態、互動系統工程、工具與資料視覺化
- 設計、使用者體驗、可用性、數字遺產、互動敘事與視覺故事
- 隱私、安全、倫理、批判性計算、跨文化互動、理論、概念與方法

特別歡迎聚焦澳門視角、本土創新、區域文化特色與全球 HCI 多元發展的投稿。
